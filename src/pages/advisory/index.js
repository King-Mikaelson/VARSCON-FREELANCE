    ...
    <div className={`bg-[#FFFFFF] flex flex-col ${dmSans.className}`}>
      ...
      <div className=" bg-white">
        ...
        <div className="lg:grid grid-cols-2 flex flex-col  gap-5 px-4  lg:px-20 xl:px-48">
          <div className="bg-[#FFFFFF] lg:flex justify-end flex-col self-center py-2 md:pb-14 pb-8 px-6  object-contain rounded-lg   ">
          ...
          <div className="bg-[#FFFFFF] lg:flex justify-between flex-col py-2 md:pb-14 pb-8 px-6  object-contain rounded-lg  ">
            <p className="text-[#162D1B] text-lg font-DMSans font-normal pt-2 pb-1">
