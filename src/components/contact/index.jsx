      ...
      <div className="xl:mt-[-29rem] lg:mt-[-29rem] flex flex-col gap-5 px-4 lg:px-20 xl:px-48 z-100 relative">
        <div className=" py-1 bg-white md:pt-24 lg:px-3 rounded-lg lg:shadow-lg  flex justify-center items-center flex-col">
          ...
          >
            ...
            <label className="flex gap-3 flex-col py-8 text-[#162D1B] font-DMSans font-bold text-md">
              Message *
              <textarea
                name="message"
                ...
                rows={4}
                cols={40}
                className="w-full h-48 lg:h-60 border border-[#E0E0E0] rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#005F56] text-[#808080] font-normal focus:border-transparent"
              />
            </label>{" "}
