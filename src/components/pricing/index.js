...
function Pricing() {
  return (
    ...
    <div className="p-10  pt-5 lg:h-[33rem] h-fit shadow-md border-[0.4px] lg:border-r-0 border-[#005F56] border-solid rounded-xl lg:rounded-br-none lg:rounded-tr-none z-0 self-center lg:justify-end flex flex-col">
       ...
       <p className="font-sans font-medium text-xl w-[18ch]">Full access to any of the following services</p>
       </div>
       <div className="flex flex-col gap-6">
        ...
        <div  className="flex gap-2">
        <IoMdCheckmarkCircleOutline size={20} color={"#005F56"} />
        <p className="font-sans font-medium text-sm">World-class referrals</p>
        </div>
        <div  className="flex gap-2">
        <IoMdCheckmarkCircleOutline size={20} color={"#005F56"} />
        ...
        <div  className="flex gap-2">
        <IoMdCheckmarkCircleOutline size={20} color={"#005F56"} />
        <p className="font-sans font-medium text-sm">Technical outsourcing</p>
        </div>
       </div>
    ...
    <div className=" pt-5 lg:px-20 p-10 lg:h-[38rem] h-fit  flex justify-center flex-col  shadow-lg box text-[#FFF] z-20 bg-[#005F56]">
       ...
       <p className="font-sans font-medium text-sm  pt-4">Free hiring advisory services</p>
       <p className="font-sans font-medium text-sm py-2">Exclusive access to our talent pool</p>
       <p className="font-sans font-medium text-sm w-[25ch] ">One month of free complimentary services (T&Cs apply)</p>
    ...
    <div className="p-10 pt-5 lg:h-[33rem] h-fit shadow-md border-[0.4px] lg:border-l-0 border-[#005F56] border-solid rounded-xl z-0 self-center  lg:rounded-bl-none lg:rounded-tl-none">
       ...
       <p className="font-sans font-medium text-sm w-[18ch] pt-4">One month of free complimentary services (T&Cs apply)</p>
